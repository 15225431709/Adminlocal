	...
	<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	                ...
	                <div class="row">
						<div class="col">
							...
							<input type="password" name="password" class="form-control" placeholder="输入密码,留空则默认为不修改">
							</div>
							...
							<option :value="data.gid">当前角色：
								<span v-if="data.gid==1">超级管理员</span>
								<span v-if="data.gid==2">管理员</span> 
							</option>
...
<style>
.modal-title{
	color:#1c1c1c;font-family: '宋体';font-weight: bolder;
}
</style>
